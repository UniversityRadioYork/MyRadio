...
sudo apt-get install apache2 libapache2-mod-php5 php5-common postgresql-9.3 postgresql-client-9.3 php-apc php5-curl php5-geoip php5-gd php5-ldap php5-mcrypt php5-pgsql php5-dev php-pear openssl
...
ln -s /var/www/myradio /vagrant_data/src
ln -s /etc/apache2/sites-enabled/myradio /vagrant_data/sample_configs/apache.conf
...
su - postgres -c "cat /vagrant_data/sample_configs/postgres.sql | psql"
