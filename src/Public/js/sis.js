...
/* Selector */
    ...
    function selectStudio(s) {
        ...
        $.get(
            myury.makeURL('SIS', 'selector.set'), {src: s}, function(data) {
    ...
    function updateSchedule() {
        $.getJSON(
            myury.makeURL('SIS','schedule.get'), function(data) {
                ...
                data.next.forEach(
                    function(e, i, data) {
                        $('#schedule-next').append(
                            '<div id="schedule-item-'+i+'" class="schedule-item"> \
            ...
            $("#trackpick-artist").autocomplete(
                {
                    source: function (request, response) {
                        ...
                        var box = "artist";
                        $.getJSON(
                            myury.makeURL('SIS','tracklist.findTrack'),
                            {
                                tname: tname,
                                album: album,
                                artist: artist,
