...
var ScheduleView = function (options) {
  ...
  var updateView = function (data) {
    ...
    for (var i = 0; i < data.payload.length; i++) {
      ...
      if (view === "week" || time.isSame(targetDay, "day") || (time.isSame(targetNextDay, "day") && time.hour() <= 6)) {
        ...
        if (nextFound === false && today && (time.isAfter() || endTime.isAfter())) {
