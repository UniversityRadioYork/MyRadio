        ...
        $('#res-dragdrop').filedrop({
            ...
            uploadFinished: function (i, file, response, time) {
                ...
                if (response['status'] == 'FAIL') {
                    ...
                    result.addClass('alert-info').append('<div id="resupload-' + i + '">' +
                    ...
                    result.append($('<a href="javascript:">Save</a>').click(function () {
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                ...
                                if (data.status == 'OK') {
                                    ...
                                    result.removeClass('alert-info')
                                            .addClass('alert-danger')
                                            .html('<div class="glyphicon glyphicon-exclamation-sign"></div><em>' + title + '</em> could not be added to library<br>'
                                                + data.error);
                                }
                            }
                        });
