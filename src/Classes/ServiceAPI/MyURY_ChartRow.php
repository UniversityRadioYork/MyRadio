<?php
/**
 * Provides the MyURY_ChartRow class for MyURY
 ...
 * @uses \Database
 */
class MyURY_ChartRow extends ServiceAPI {
  /**
  ...
  /**
   * Constructs a new MyURY_ChartRow from the database.
   *
   * You should generally use MyURY_ChartRow::getInstance instead.
   *
  ...
  /**
   * Retrieves the MyURY_ChartRow with the given numeric ID.
   *
   * @param $chart_row_id  The numeric ID of the chart row.
   */
   ...
   *                     'trackid'.
   * @return MyURY_ChartRow  The newly created track.
   */
