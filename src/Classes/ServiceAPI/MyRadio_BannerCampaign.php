...
class MyRadio_BannerCampaign extends ServiceAPI {
   ...
   */
  public static function create(MyRadio_Banner $banner, $banner_location_id = 1, $effective_from = null,
  ...
  public static function getBannerCampaignForm($bannerid = null) {
    return (new MyRadioForm('bannercampaignfrm', 'Website', 'doCreateCampaign', [
                ...
                'title' => 'Edit Banner Campaign'
                    ...
                    ->addField(new MyRadioFormField('effective_to', MyRadioFormField::TYPE_DATETIME, [
                        'required' => false,
                        'label' => 'End Time',
                    ...
                    ->addField(new MyRadioFormField('location', MyRadioFormField::TYPE_SELECT, [
                        'label' => 'Location',
                        'explanation' => 'Choose where on the website this Campaign is run.',
                        'options' => self::getCampaignLocations()
                    ]))
                    ->addField(new MyRadioFormField('timeslots', MyRadioFormField::TYPE_WEEKSELECT, [
                        'label' => 'Timeslots',
                    ...
                    ->addField(new MyRadioFormField('bannerid', MyRadioFormField::TYPE_HIDDEN, [
                        'value' => $bannerid
    ]));
  }
