...
class MyURY_JsonFormLoader {
  ...
  /**
   * The name of the current MyURY module.
   * @var string
   */
  private $module;
  ...
  /**
   * Constructs a new MyURY_JsonFormLoader.
   *
   * @param string $module  The name of the calling MyURY module.
   *
   * @return MyURY_JsonFormLoader
   */
  public function __construct($module) {
    $this->module = $module;
    $this->form_array = null;
    $this->rc = new ReflectionClass('MyURYFormField');
  }
   ...
   *                            section.
   * @param MyURYForm $form     The form to add the compiled field to.
  ...
  private function addNormalFieldToForm($name, $field, $form, $binds) {
    ...
    $form->addField(new MyURYFormField($name, $type, $field));
  }
   ...
   * @return MyURY_JsonFormLoader  this.
   */
   ...
   *                           variables.
   *
   * @return MyURYForm  The processed form.
   */
  ...
  /**
   * Loads and renders a form from its MyURY module and name.
   *
  ...
  public static function loadFromModule($module, $name, $action, $binds=[]) {
    return (
      new MyURY_JsonFormLoader($module)
