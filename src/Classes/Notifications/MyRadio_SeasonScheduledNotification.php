...
class MyRadio_SeasonScheduledNotification extends MyRadio_Notification implements MyRadio_EmailNotification
{
    /**
     * @var MyRadio_Show
     */
...
Remember that except in exceptional circumstances, you must give at least 48 hours notice for cancelling your show as
part of your presenter contract.

If you do not do this for two shows in one season, all other shows are forfeit and may be cancelled.

You can cancel an episode by opening MyRadio and going to My Shows, clicking on the seasons number, then the episode's
number, and clicking the cancel icon on the episode you want to cancel.
