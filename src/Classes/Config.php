...
final class Config {
   ...
   * @var String
   */
  public static $webcam_current_url = "http://uryrrod.york.ac.uk:9090/current?noprotocol=true";

  /**
   * The url of the webcam server setter
   * @var String
   */
  public static $webcam_set_url = "http://uryrrod.york.ac.uk:9090/set?newcam=";
