...
$twig->setTemplate('error.twig')
        ...
        ->addVariable('title', 'Whoopsie')
        ->addVariable('heading', 'You Mean I\'m Not Really a Teapot?')
        ->addVariable('body', '<p>I\'m sorry, but the server got very, very confused trying to do what you asked and had an existentical crisis.</p>
