 ...
 */
$form = (new MyRadioForm('sched_show', 'Scheduler', 'doShow', array(
    'debug' => true,
    'title' => 'Edit Show'
        )
        ))->addField(
                ...
                new MyRadioFormField('title', MyRadioFormField::TYPE_TEXT, array(
            'explanation' => 'Enter a name for your new show. Try and make it unique.',
            'label' => 'Show Name'
                )
                )
        )->addField(
                new MyRadioFormField('description', MyRadioFormField::TYPE_BLOCKTEXT, array(
            ...
            'explanation' => 'What type of music do you play, if any?'
                ...
                new MyRadioFormField('tags', MyRadioFormField::TYPE_TEXT, array(
            'label' => 'Tags',
